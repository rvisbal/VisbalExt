...
export class GitHistoryViewPanels {
    private static currentPanel: GitHistoryViewPanels | undefined;
    ...
    public static createOrShow(
        ...
        if (GitHistoryViewPanels.currentPanel) {
            GitHistoryViewPanels.currentPanel._panel.reveal(column);
        } else {
            ...
            GitHistoryViewPanels.currentPanel = new GitHistoryViewPanels(panel, gitService);
        }

        GitHistoryViewPanels.currentPanel.updateContent(filePath, startLine, endLine);
    }
    ...
    public dispose() {
        GitHistoryViewPanels.currentPanel = undefined;
        this._panel.dispose();
